package top.moma.m78.framework.customizer.exception;
...
import top.moma.m78.framework.customizer.exception.exceptions.ServiceException;
 ...
 *
 * @author ivan
 * @version 1.0 Created by ivan on 1/7/19 - 4:40 PM.
 */
@Slf4j
public class GeneralExceptionHandler extends AbstractHandlerExceptionResolver {
  ...
  protected void handleApi(
    ...
    ResponseHelper.response(request, response, ex.getResponseStatusInfo());
  }
